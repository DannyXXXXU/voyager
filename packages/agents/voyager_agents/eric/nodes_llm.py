...
_SYS_HOOKS = (
    ...
    "- DO NOT split one sentence into two hooks. If a sentence joins clauses with "
    "\"otherwise\", \"and\", \"which\", \"because\", \"so that\", keep it as a SINGLE hook "
    "covering the whole sentence. One sentence = one hook.\n"
